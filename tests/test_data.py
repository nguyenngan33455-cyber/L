...
class TestDataLoader:
    ...
    def test_get_projectiles(self, temp_data_dir):
        ...
        (temp_data_dir / "projectiles.json").write_text(json.dumps({"bullet": {"speed": 1000}}))
    ...
    def test_get_effects(self, temp_data_dir):
        """Test get_effects."""
        (temp_data_dir / "effects.json").write_text(json.dumps({"burn": {"duration": 3.0}}))
    ...
    def test_get_buffs(self, temp_data_dir):
        """Test get_buffs."""
        (temp_data_dir / "buffs.json").write_text(json.dumps({"damage_boost": {"modifier": 1.25}}))
    ...
    def test_get_loot(self, temp_data_dir):
        """Test get_loot."""
        (temp_data_dir / "loot.json").write_text(json.dumps({"health_pack": {"healing": 50}}))
