...
from zbgym.physics.body import BodyType, BoundingBox, DynamicBody
...
class TestDynamicBody:
    ...
    def test_create_with_position(self):
        ...
        body = DynamicBody(id="test", position=Vector2D(100.0, 200.0))
    ...
    def test_create_with_velocity(self):
        ...
        body = DynamicBody(id="test", velocity=Vector2D(10.0, 5.0))
