"""Auto-generated weapon plugin: WeaponIconDictionary."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "weapon_icon_dictionary",
    "WeaponIconDictionary",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class WeaponIconDictionary(Weapon):
    """Weapon plugin for WeaponIconDictionary."""
