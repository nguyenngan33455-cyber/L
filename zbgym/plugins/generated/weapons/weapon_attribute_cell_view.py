"""Auto-generated weapon plugin: WeaponAttributeCellView."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "weapon_attribute_cell_view",
    "WeaponAttributeCellView",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class WeaponAttributeCellView(Weapon):
    """Weapon plugin for WeaponAttributeCellView."""
