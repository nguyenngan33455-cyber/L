"""Auto-generated weapon plugin: WeaponStatsHeaderView."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "weapon_stats_header_view",
    "WeaponStatsHeaderView",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class WeaponStatsHeaderView(Weapon):
    """Weapon plugin for WeaponStatsHeaderView."""
