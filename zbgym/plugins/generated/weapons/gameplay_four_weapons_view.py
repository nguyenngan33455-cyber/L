"""Auto-generated weapon plugin: GameplayFourWeaponsView."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "gameplay_four_weapons_view",
    "GameplayFourWeaponsView",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class GameplayFourWeaponsView(Weapon):
    """Weapon plugin for GameplayFourWeaponsView."""
