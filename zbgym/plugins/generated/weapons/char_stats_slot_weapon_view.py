"""Auto-generated weapon plugin: CharStatsSlotWeaponView."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "char_stats_slot_weapon_view",
    "CharStatsSlotWeaponView",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class CharStatsSlotWeaponView(Weapon):
    """Weapon plugin for CharStatsSlotWeaponView."""
