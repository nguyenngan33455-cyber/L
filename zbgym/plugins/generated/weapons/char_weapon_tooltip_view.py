"""Auto-generated weapon plugin: CharWeaponTooltipView."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "char_weapon_tooltip_view",
    "CharWeaponTooltipView",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class CharWeaponTooltipView(Weapon):
    """Weapon plugin for CharWeaponTooltipView."""
