"""Auto-generated weapon plugin: FourthWeaponController."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "fourth_weapon_controller",
    "FourthWeaponController",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class FourthWeaponController(Weapon):
    """Weapon plugin for FourthWeaponController."""
