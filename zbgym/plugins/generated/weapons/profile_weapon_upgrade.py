"""Auto-generated weapon plugin: ProfileWeaponUpgrade."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "profile_weapon_upgrade",
    "ProfileWeaponUpgrade",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class ProfileWeaponUpgrade(Weapon):
    """Weapon plugin for ProfileWeaponUpgrade."""
