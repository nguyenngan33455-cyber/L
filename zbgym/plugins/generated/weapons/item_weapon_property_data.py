"""Auto-generated weapon plugin: ItemWeaponPropertyData."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "item_weapon_property_data",
    "ItemWeaponPropertyData",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class ItemWeaponPropertyData(Weapon):
    """Weapon plugin for ItemWeaponPropertyData."""
