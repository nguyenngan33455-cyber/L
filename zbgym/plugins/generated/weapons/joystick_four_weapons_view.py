"""Auto-generated weapon plugin: JoystickFourWeaponsView."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "joystick_four_weapons_view",
    "JoystickFourWeaponsView",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class JoystickFourWeaponsView(Weapon):
    """Weapon plugin for JoystickFourWeaponsView."""
