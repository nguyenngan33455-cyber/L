"""Auto-generated weapon plugin: WeaponNumberExtensions."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "weapon_number_extensions",
    "WeaponNumberExtensions",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class WeaponNumberExtensions(Weapon):
    """Weapon plugin for WeaponNumberExtensions."""
