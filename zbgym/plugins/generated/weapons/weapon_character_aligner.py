"""Auto-generated weapon plugin: WeaponCharacterAligner."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "weapon_character_aligner",
    "WeaponCharacterAligner",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class WeaponCharacterAligner(Weapon):
    """Weapon plugin for WeaponCharacterAligner."""
