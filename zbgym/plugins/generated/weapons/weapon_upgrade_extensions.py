"""Auto-generated weapon plugin: WeaponUpgradeExtensions."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "weapon_upgrade_extensions",
    "WeaponUpgradeExtensions",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class WeaponUpgradeExtensions(Weapon):
    """Weapon plugin for WeaponUpgradeExtensions."""
