"""Auto-generated weapon plugin: WeaponSoundBehaviour."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "weapon_sound_behaviour",
    "WeaponSoundBehaviour",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class WeaponSoundBehaviour(Weapon):
    """Weapon plugin for WeaponSoundBehaviour."""
