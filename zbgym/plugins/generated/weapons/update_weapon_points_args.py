"""Auto-generated weapon plugin: UpdateWeaponPointsArgs."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "update_weapon_points_args",
    "UpdateWeaponPointsArgs",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class UpdateWeaponPointsArgs(Weapon):
    """Weapon plugin for UpdateWeaponPointsArgs."""
