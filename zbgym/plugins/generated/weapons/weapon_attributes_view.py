"""Auto-generated weapon plugin: WeaponAttributesView."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "weapon_attributes_view",
    "WeaponAttributesView",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class WeaponAttributesView(Weapon):
    """Weapon plugin for WeaponAttributesView."""
