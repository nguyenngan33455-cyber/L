"""Auto-generated weapon plugin: ProfileWeaponAttribute."""

from zbgym.plugins.weapon import Weapon, WeaponStats, WeaponType, register_weapon


@register_weapon(
    "profile_weapon_attribute",
    "ProfileWeaponAttribute",
    WeaponType.RIFLE,
    WeaponStats(
        damage=10.0,
        fire_rate=10.0,
...
class ProfileWeaponAttribute(Weapon):
    """Weapon plugin for ProfileWeaponAttribute."""
