"""Auto-generated skill plugin: SelfSkillHitParametersHelper."""
...
@register_skill(
    "self_skill_hit_parameters_helper",
    "SelfSkillHitParametersHelper",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SelfSkillHitParametersHelperSkill(Skill):
    """Skill plugin for SelfSkillHitParametersHelper."""
