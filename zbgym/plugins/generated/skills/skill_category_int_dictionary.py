"""Auto-generated skill plugin: SkillCategoryIntDictionary."""
...
@register_skill(
    "skill_category_int_dictionary",
    "SkillCategoryIntDictionary",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillCategoryIntDictionarySkill(Skill):
    """Skill plugin for SkillCategoryIntDictionary."""
