"""Auto-generated skill plugin: CapybaraSkillStatusParameters."""
...
@register_skill(
    "capybara_skill_status_parameters",
    "CapybaraSkillStatusParameters",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class CapybaraSkillStatusParametersSkill(Skill):
    """Skill plugin for CapybaraSkillStatusParameters."""
