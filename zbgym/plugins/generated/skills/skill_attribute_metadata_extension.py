"""Auto-generated skill plugin: SkillAttributeMetadataExtension."""
...
@register_skill(
    "skill_attribute_metadata_extension",
    "SkillAttributeMetadataExtension",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillAttributeMetadataExtensionSkill(Skill):
    """Skill plugin for SkillAttributeMetadataExtension."""
