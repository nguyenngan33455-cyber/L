"""Auto-generated skill plugin: SkillPriorityOptions."""
...
@register_skill(
    "skill_priority_options",
    "SkillPriorityOptions",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillPriorityOptionsSkill(Skill):
    """Skill plugin for SkillPriorityOptions."""
