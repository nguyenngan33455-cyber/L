"""Auto-generated skill plugin: EggLandmineSkillController."""
...
@register_skill(
    "egg_landmine_skill_controller",
    "EggLandmineSkillController",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class EggLandmineSkillControllerSkill(Skill):
    """Skill plugin for EggLandmineSkillController."""
