"""Auto-generated skill plugin: CancelSkillGameInput."""
...
@register_skill(
    "cancel_skill_game_input",
    "CancelSkillGameInput",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class CancelSkillGameInputSkill(Skill):
    """Skill plugin for CancelSkillGameInput."""
