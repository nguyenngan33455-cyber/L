"""Auto-generated skill plugin: RegenOnSkillUsePrimalInstinct."""
...
@register_skill(
    "regen_on_skill_use_primal_instinct",
    "RegenOnSkillUsePrimalInstinct",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class RegenOnSkillUsePrimalInstinctSkill(Skill):
    """Skill plugin for RegenOnSkillUsePrimalInstinct."""
