"""Auto-generated skill plugin: SkillRarityMultiplierBehaviour."""
...
@register_skill(
    "skill_rarity_multiplier_behaviour",
    "SkillRarityMultiplierBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillRarityMultiplierBehaviourSkill(Skill):
    """Skill plugin for SkillRarityMultiplierBehaviour."""
