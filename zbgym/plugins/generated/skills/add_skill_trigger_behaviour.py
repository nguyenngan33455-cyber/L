"""Auto-generated skill plugin: AddSkillTriggerBehaviour."""
...
@register_skill(
    "add_skill_trigger_behaviour",
    "AddSkillTriggerBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class AddSkillTriggerBehaviourSkill(Skill):
    """Skill plugin for AddSkillTriggerBehaviour."""
