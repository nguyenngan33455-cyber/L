"""Auto-generated skill plugin: GameModeFlavorTriggerSkillObject."""
...
@register_skill(
    "game_mode_flavor_trigger_skill_object",
    "GameModeFlavorTriggerSkillObject",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class GameModeFlavorTriggerSkillObjectSkill(Skill):
    """Skill plugin for GameModeFlavorTriggerSkillObject."""
