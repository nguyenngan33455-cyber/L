"""Auto-generated skill plugin: SkillRarityExtensions."""
...
@register_skill(
    "skill_rarity_extensions",
    "SkillRarityExtensions",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillRarityExtensionsSkill(Skill):
    """Skill plugin for SkillRarityExtensions."""
