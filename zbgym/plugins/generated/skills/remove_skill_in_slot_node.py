"""Auto-generated skill plugin: RemoveSkillInSlotNode."""
...
@register_skill(
    "remove_skill_in_slot_node",
    "RemoveSkillInSlotNode",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class RemoveSkillInSlotNodeSkill(Skill):
    """Skill plugin for RemoveSkillInSlotNode."""
