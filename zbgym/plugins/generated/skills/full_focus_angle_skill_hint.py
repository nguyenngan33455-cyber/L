"""Auto-generated skill plugin: FullFocusAngleSkillHint."""
...
@register_skill(
    "full_focus_angle_skill_hint",
    "FullFocusAngleSkillHint",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class FullFocusAngleSkillHintSkill(Skill):
    """Skill plugin for FullFocusAngleSkillHint."""
