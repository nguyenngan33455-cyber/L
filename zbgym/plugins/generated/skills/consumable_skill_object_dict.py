"""Auto-generated skill plugin: ConsumableSkillObjectDict."""
...
@register_skill(
    "consumable_skill_object_dict",
    "ConsumableSkillObjectDict",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class ConsumableSkillObjectDictSkill(Skill):
    """Skill plugin for ConsumableSkillObjectDict."""
