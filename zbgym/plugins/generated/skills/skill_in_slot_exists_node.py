"""Auto-generated skill plugin: SkillInSlotExistsNode."""
...
@register_skill(
    "skill_in_slot_exists_node",
    "SkillInSlotExistsNode",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillInSlotExistsNodeSkill(Skill):
    """Skill plugin for SkillInSlotExistsNode."""
