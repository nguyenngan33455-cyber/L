"""Auto-generated skill plugin: SniperSkillBehaviour."""
...
@register_skill(
    "sniper_skill_behaviour",
    "SniperSkillBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SniperSkillBehaviourSkill(Skill):
    """Skill plugin for SniperSkillBehaviour."""
