"""Auto-generated skill plugin: ArrowRainSkillBehaviour."""
...
@register_skill(
    "arrow_rain_skill_behaviour",
    "ArrowRainSkillBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class ArrowRainSkillBehaviourSkill(Skill):
    """Skill plugin for ArrowRainSkillBehaviour."""
