"""Auto-generated skill plugin: SkillAPIGameInputSystem."""
...
@register_skill(
    "skill_a_p_i_game_input_system",
    "SkillAPIGameInputSystem",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillAPIGameInputSystemSkill(Skill):
    """Skill plugin for SkillAPIGameInputSystem."""
