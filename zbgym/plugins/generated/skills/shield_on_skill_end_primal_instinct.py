"""Auto-generated skill plugin: ShieldOnSkillEndPrimalInstinct."""
...
@register_skill(
    "shield_on_skill_end_primal_instinct",
    "ShieldOnSkillEndPrimalInstinct",
    SkillType.SHIELD,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class ShieldOnSkillEndPrimalInstinctSkill(Skill):
    """Skill plugin for ShieldOnSkillEndPrimalInstinct."""
