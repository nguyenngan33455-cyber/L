"""Auto-generated skill plugin: AddSkillTriggerChecker."""
...
@register_skill(
    "add_skill_trigger_checker",
    "AddSkillTriggerChecker",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class AddSkillTriggerCheckerSkill(Skill):
    """Skill plugin for AddSkillTriggerChecker."""
