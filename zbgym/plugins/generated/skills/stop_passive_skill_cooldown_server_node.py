"""Auto-generated skill plugin: StopPassiveSkillCooldownServerNode."""
...
@register_skill(
    "stop_passive_skill_cooldown_server_node",
    "StopPassiveSkillCooldownServerNode",
    SkillType.PASSIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class StopPassiveSkillCooldownServerNodeSkill(Skill):
    """Skill plugin for StopPassiveSkillCooldownServerNode."""
