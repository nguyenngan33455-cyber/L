"""Auto-generated skill plugin: SkillSpriteDictionary."""
...
@register_skill(
    "skill_sprite_dictionary",
    "SkillSpriteDictionary",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillSpriteDictionarySkill(Skill):
    """Skill plugin for SkillSpriteDictionary."""
