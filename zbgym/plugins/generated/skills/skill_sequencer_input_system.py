"""Auto-generated skill plugin: SkillSequencerInputSystem."""
...
@register_skill(
    "skill_sequencer_input_system",
    "SkillSequencerInputSystem",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillSequencerInputSystemSkill(Skill):
    """Skill plugin for SkillSequencerInputSystem."""
