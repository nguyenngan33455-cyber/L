"""Auto-generated skill plugin: MachineGunSkillBehaviour."""
...
@register_skill(
    "machine_gun_skill_behaviour",
    "MachineGunSkillBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class MachineGunSkillBehaviourSkill(Skill):
    """Skill plugin for MachineGunSkillBehaviour."""
