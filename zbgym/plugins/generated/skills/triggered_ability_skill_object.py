"""Auto-generated skill plugin: TriggeredAbilitySkillObject."""
...
@register_skill(
    "triggered_ability_skill_object",
    "TriggeredAbilitySkillObject",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class TriggeredAbilitySkillObjectSkill(Skill):
    """Skill plugin for TriggeredAbilitySkillObject."""
