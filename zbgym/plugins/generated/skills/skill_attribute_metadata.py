"""Auto-generated skill plugin: SkillAttributeMetadata."""
...
@register_skill(
    "skill_attribute_metadata",
    "SkillAttributeMetadata",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillAttributeMetadataSkill(Skill):
    """Skill plugin for SkillAttributeMetadata."""
