"""Auto-generated skill plugin: AttractOnSkillPrimalInstinct."""
...
@register_skill(
    "attract_on_skill_primal_instinct",
    "AttractOnSkillPrimalInstinct",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class AttractOnSkillPrimalInstinctSkill(Skill):
    """Skill plugin for AttractOnSkillPrimalInstinct."""
