"""Auto-generated skill plugin: PassiveSkillDescriptionDictionary."""
...
@register_skill(
    "passive_skill_description_dictionary",
    "PassiveSkillDescriptionDictionary",
    SkillType.PASSIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class PassiveSkillDescriptionDictionarySkill(Skill):
    """Skill plugin for PassiveSkillDescriptionDictionary."""
