"""Auto-generated skill plugin: StartPassiveSkillNode."""
...
@register_skill(
    "start_passive_skill_node",
    "StartPassiveSkillNode",
    SkillType.PASSIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class StartPassiveSkillNodeSkill(Skill):
    """Skill plugin for StartPassiveSkillNode."""
