"""Auto-generated skill plugin: AbilitySystemSkillHint."""
...
@register_skill(
    "ability_system_skill_hint",
    "AbilitySystemSkillHint",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class AbilitySystemSkillHintSkill(Skill):
    """Skill plugin for AbilitySystemSkillHint."""
