"""Auto-generated skill plugin: SkillAPISpecialGameInputSystem."""
...
@register_skill(
    "skill_a_p_i_special_game_input_system",
    "SkillAPISpecialGameInputSystem",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillAPISpecialGameInputSystemSkill(Skill):
    """Skill plugin for SkillAPISpecialGameInputSystem."""
