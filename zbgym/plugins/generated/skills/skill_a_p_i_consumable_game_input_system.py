"""Auto-generated skill plugin: SkillAPIConsumableGameInputSystem."""
...
@register_skill(
    "skill_a_p_i_consumable_game_input_system",
    "SkillAPIConsumableGameInputSystem",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillAPIConsumableGameInputSystemSkill(Skill):
    """Skill plugin for SkillAPIConsumableGameInputSystem."""
