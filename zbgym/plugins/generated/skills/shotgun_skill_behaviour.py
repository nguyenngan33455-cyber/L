"""Auto-generated skill plugin: ShotgunSkillBehaviour."""
...
@register_skill(
    "shotgun_skill_behaviour",
    "ShotgunSkillBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class ShotgunSkillBehaviourSkill(Skill):
    """Skill plugin for ShotgunSkillBehaviour."""
