"""Auto-generated skill plugin: GameModeFlavorsTriggerSkillFactory."""
...
@register_skill(
    "game_mode_flavors_trigger_skill_factory",
    "GameModeFlavorsTriggerSkillFactory",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class GameModeFlavorsTriggerSkillFactorySkill(Skill):
    """Skill plugin for GameModeFlavorsTriggerSkillFactory."""
