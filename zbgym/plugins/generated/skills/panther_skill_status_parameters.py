"""Auto-generated skill plugin: PantherSkillStatusParameters."""
...
@register_skill(
    "panther_skill_status_parameters",
    "PantherSkillStatusParameters",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class PantherSkillStatusParametersSkill(Skill):
    """Skill plugin for PantherSkillStatusParameters."""
