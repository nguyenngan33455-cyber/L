...
@register_skill(
    "speed_life_regen_on_skill_damage_primal_instinct",
    "SpeedLifeRegenOnSkillDamagePrimalInstinct",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SpeedLifeRegenOnSkillDamagePrimalInstinctSkill(Skill):
    """Skill plugin for SpeedLifeRegenOnSkillDamagePrimalInstinct."""
