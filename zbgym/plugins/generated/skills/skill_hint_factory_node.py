"""Auto-generated skill plugin: SkillHintFactoryNode."""
...
@register_skill(
    "skill_hint_factory_node",
    "SkillHintFactoryNode",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillHintFactoryNodeSkill(Skill):
    """Skill plugin for SkillHintFactoryNode."""
