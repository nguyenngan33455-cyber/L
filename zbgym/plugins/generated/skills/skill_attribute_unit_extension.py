"""Auto-generated skill plugin: SkillAttributeUnitExtension."""
...
@register_skill(
    "skill_attribute_unit_extension",
    "SkillAttributeUnitExtension",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillAttributeUnitExtensionSkill(Skill):
    """Skill plugin for SkillAttributeUnitExtension."""
