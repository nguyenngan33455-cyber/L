"""Auto-generated skill plugin: GetGameModeFlavorTriggerSkillData."""
...
@register_skill(
    "get_game_mode_flavor_trigger_skill_data",
    "GetGameModeFlavorTriggerSkillData",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class GetGameModeFlavorTriggerSkillDataSkill(Skill):
    """Skill plugin for GetGameModeFlavorTriggerSkillData."""
