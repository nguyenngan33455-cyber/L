"""Auto-generated skill plugin: SpeedDamageBoostOnSkillEndPrimalInstinct."""
...
@register_skill(
    "speed_damage_boost_on_skill_end_primal_instinct",
    "SpeedDamageBoostOnSkillEndPrimalInstinct",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SpeedDamageBoostOnSkillEndPrimalInstinctSkill(Skill):
    """Skill plugin for SpeedDamageBoostOnSkillEndPrimalInstinct."""
