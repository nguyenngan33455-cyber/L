"""Auto-generated skill plugin: AddSkillOnRespawnRules."""
...
@register_skill(
    "add_skill_on_respawn_rules",
    "AddSkillOnRespawnRules",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class AddSkillOnRespawnRulesSkill(Skill):
    """Skill plugin for AddSkillOnRespawnRules."""
