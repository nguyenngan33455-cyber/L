"""Auto-generated skill plugin: SlowAreaOnSkillStartPrimalInstinct."""
...
@register_skill(
    "slow_area_on_skill_start_primal_instinct",
    "SlowAreaOnSkillStartPrimalInstinct",
    SkillType.AOE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SlowAreaOnSkillStartPrimalInstinctSkill(Skill):
    """Skill plugin for SlowAreaOnSkillStartPrimalInstinct."""
