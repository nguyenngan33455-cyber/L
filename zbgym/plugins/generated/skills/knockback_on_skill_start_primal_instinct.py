"""Auto-generated skill plugin: KnockbackOnSkillStartPrimalInstinct."""
...
@register_skill(
    "knockback_on_skill_start_primal_instinct",
    "KnockbackOnSkillStartPrimalInstinct",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class KnockbackOnSkillStartPrimalInstinctSkill(Skill):
    """Skill plugin for KnockbackOnSkillStartPrimalInstinct."""
