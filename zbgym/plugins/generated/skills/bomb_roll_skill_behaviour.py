"""Auto-generated skill plugin: BombRollSkillBehaviour."""
...
@register_skill(
    "bomb_roll_skill_behaviour",
    "BombRollSkillBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class BombRollSkillBehaviourSkill(Skill):
    """Skill plugin for BombRollSkillBehaviour."""
