"""Auto-generated skill plugin: QuillTrapSkillController."""
...
@register_skill(
    "quill_trap_skill_controller",
    "QuillTrapSkillController",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class QuillTrapSkillControllerSkill(Skill):
    """Skill plugin for QuillTrapSkillController."""
