"""Auto-generated skill plugin: SkillSequencerInputController."""
...
@register_skill(
    "skill_sequencer_input_controller",
    "SkillSequencerInputController",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillSequencerInputControllerSkill(Skill):
    """Skill plugin for SkillSequencerInputController."""
