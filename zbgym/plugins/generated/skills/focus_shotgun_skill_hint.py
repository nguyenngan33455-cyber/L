"""Auto-generated skill plugin: FocusShotgunSkillHint."""
...
@register_skill(
    "focus_shotgun_skill_hint",
    "FocusShotgunSkillHint",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class FocusShotgunSkillHintSkill(Skill):
    """Skill plugin for FocusShotgunSkillHint."""
