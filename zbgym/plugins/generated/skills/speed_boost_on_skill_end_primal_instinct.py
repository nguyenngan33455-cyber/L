"""Auto-generated skill plugin: SpeedBoostOnSkillEndPrimalInstinct."""
...
@register_skill(
    "speed_boost_on_skill_end_primal_instinct",
    "SpeedBoostOnSkillEndPrimalInstinct",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SpeedBoostOnSkillEndPrimalInstinctSkill(Skill):
    """Skill plugin for SpeedBoostOnSkillEndPrimalInstinct."""
