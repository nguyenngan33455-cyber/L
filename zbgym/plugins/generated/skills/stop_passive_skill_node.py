"""Auto-generated skill plugin: StopPassiveSkillNode."""
...
@register_skill(
    "stop_passive_skill_node",
    "StopPassiveSkillNode",
    SkillType.PASSIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class StopPassiveSkillNodeSkill(Skill):
    """Skill plugin for StopPassiveSkillNode."""
