"""Auto-generated skill plugin: SpartanSpearSkillBehaviour."""
...
@register_skill(
    "spartan_spear_skill_behaviour",
    "SpartanSpearSkillBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SpartanSpearSkillBehaviourSkill(Skill):
    """Skill plugin for SpartanSpearSkillBehaviour."""
