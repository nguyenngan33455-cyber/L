"""Auto-generated skill plugin: DroppableSkillModelConfig."""
...
@register_skill(
    "droppable_skill_model_config",
    "DroppableSkillModelConfig",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class DroppableSkillModelConfigSkill(Skill):
    """Skill plugin for DroppableSkillModelConfig."""
