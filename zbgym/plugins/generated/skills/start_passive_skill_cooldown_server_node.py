"""Auto-generated skill plugin: StartPassiveSkillCooldownServerNode."""
...
@register_skill(
    "start_passive_skill_cooldown_server_node",
    "StartPassiveSkillCooldownServerNode",
    SkillType.PASSIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class StartPassiveSkillCooldownServerNodeSkill(Skill):
    """Skill plugin for StartPassiveSkillCooldownServerNode."""
