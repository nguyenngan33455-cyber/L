"""Auto-generated skill plugin: StopPassiveSkillCooldownNode."""
...
@register_skill(
    "stop_passive_skill_cooldown_node",
    "StopPassiveSkillCooldownNode",
    SkillType.PASSIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class StopPassiveSkillCooldownNodeSkill(Skill):
    """Skill plugin for StopPassiveSkillCooldownNode."""
