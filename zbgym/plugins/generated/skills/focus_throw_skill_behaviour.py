"""Auto-generated skill plugin: FocusThrowSkillBehaviour."""
...
@register_skill(
    "focus_throw_skill_behaviour",
    "FocusThrowSkillBehaviour",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class FocusThrowSkillBehaviourSkill(Skill):
    """Skill plugin for FocusThrowSkillBehaviour."""
