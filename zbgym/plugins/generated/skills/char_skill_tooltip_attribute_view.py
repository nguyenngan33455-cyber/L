"""Auto-generated skill plugin: CharSkillTooltipAttributeView."""
...
@register_skill(
    "char_skill_tooltip_attribute_view",
    "CharSkillTooltipAttributeView",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class CharSkillTooltipAttributeViewSkill(Skill):
    """Skill plugin for CharSkillTooltipAttributeView."""
