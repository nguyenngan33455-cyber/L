"""Auto-generated skill plugin: SkillAPIShootGameInputSystem."""
...
@register_skill(
    "skill_a_p_i_shoot_game_input_system",
    "SkillAPIShootGameInputSystem",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillAPIShootGameInputSystemSkill(Skill):
    """Skill plugin for SkillAPIShootGameInputSystem."""
