"""Auto-generated skill plugin: SkillsInitialDropsConfig."""
...
@register_skill(
    "skills_initial_drops_config",
    "SkillsInitialDropsConfig",
    SkillType.ACTIVE,
    SkillConfig(
        cooldown=5.0,
        energy_cost=0.0,
...
class SkillsInitialDropsConfigSkill(Skill):
    """Skill plugin for SkillsInitialDropsConfig."""
